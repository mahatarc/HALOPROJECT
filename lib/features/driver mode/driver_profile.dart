...
class _DeliveryBoyProfileState extends State<DeliveryBoyProfile> {
  ...
  TextEditingController nameController = TextEditingController(text: 'Hari Bahadur');
  TextEditingController phoneController = TextEditingController(text: '9850434678');
  TextEditingController locationController = TextEditingController(text: 'Kalimati');
